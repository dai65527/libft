...
#    Updated: 2020/10/05 20:28:04 by dnakano          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
TESTNAME		:= test.out
TESTSRCNAME		:= test.c
TESTINCLUDENAME	:= test_memset.c test_strlen.c test_strlcpy.c test_strlcat.c test_strncmp.c test_isxxx.c test_toxxx.c
