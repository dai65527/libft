...
#    Updated: 2020/10/05 19:37:16 by dnakano          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CC				:= gcc
CFLAGS			:= -Wall -Werror -Wextra
SRCNAME			:= ft_strlen.c ft_strlcpy.c ft_strlcat.c ft_strncmp.c\
...
TESTNAME		:= test.out
TESTSRCNAME		:= test.c
TESTINCLUDENAME	:= test_strlen.c test_strlcpy.c test_strlcat.c test_strncmp.c test_isxxx.c test_toxxx.c
